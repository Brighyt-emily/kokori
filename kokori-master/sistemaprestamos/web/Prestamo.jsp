            ...
            <div class="row center">
                <div class="col s5">
                    <div class="input-field">
                        ...
                        <input  id="autocomplete-profesor" class="autocomplete" type="text" maxlength="8" name="dnipro" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col s5">
                    <div class="input-field">
                        ...
                        <input type="text" name="equipo" id="autocomplete-equipo" class="autocomplete"  required>
                    </div>
                </div>
                <div class="col s5">
